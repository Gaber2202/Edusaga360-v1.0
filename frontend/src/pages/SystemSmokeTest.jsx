...
const SMOKE_TESTS = [
  ...
  },
  {
    ...
    nameAr: 'كيان الطالب',
    test: async () => {
      const students = await tenantQuery('students').select('*').order('created_date', { ascending: false }).limit();
  ...
  },
  {
    ...
    nameAr: 'كيان الموظف',
    test: async () => {
      const employees = await tenantQuery('employees').select('id, employee_id, name_ar, name_en, status, job_title, department_id, branch_id, hire_date, end_date, is_saudi, is_gosi_applicable, iqama_expiry, passport_expiry, visa_expiry, nationality, gender, employment_type, photo_url, user_id, created_date').order('created_date', { ascending: false }).limit();
  ...
  },
  {
    ...
    nameAr: 'كيان الفرع',
    test: async () => {
      const branches = await tenantQuery('branches').select('*').order('created_date', { ascending: false }).limit();
  ...
  },
  {
    ...
    test: async () => {
      const errors = await tenantQuery('system_errors').select('*').order('created_date', { ascending: false }).limit();
