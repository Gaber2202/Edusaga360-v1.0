            ...
            <div className="space-y-3">
              <div className="flex flex-wrap gap-2">
                {formData.documents?.map((doc, i) => (
                  <div key={i} className="flex items-center gap-2 bg-slate-100 px-3 py-2 rounded-lg">
                    <FileText className="w-4 h-4 text-slate-500" />
                    <a href={doc.url} target="_blank" rel="noopener noreferrer" className="text-sm text-slate-700 hover:underline">
                      {doc.name}
                    </a>
