...
export default function UserNotRegisteredError() {
  ...
  if (status === 'awaiting_setup') {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-sand via-najdi-50 to-sand p-4" dir="rtl">
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-border p-8 text-center space-y-5">
          <Logo />
          <div className="w-16 h-16 bg-najdi-50 rounded-full flex items-center justify-center mx-auto">
            <svg className="w-8 h-8 text-najdi-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>
          <div>
            <h1 className="text-xl font-bold text-ink">تم قبول طلبك!</h1>
          ...
          <button onClick={handleLogout} className="w-full py-2.5 px-4 border border-border text-muted-foreground font-medium rounded-xl hover:bg-sand transition-colors text-sm">
            تسجيل الخروج
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-sand via-najdi-50 to-sand p-4" dir="rtl">
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-border p-8 text-center space-y-5">
        ...
        <div>
          <h1 className="text-xl font-bold text-ink">طلبك قيد المراجعة</h1>
          <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
