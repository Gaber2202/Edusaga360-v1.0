...
const SALARY_COMPONENTS = [
  ...
  { name_ar: 'بدل المواصلات', name_en: 'Transport Allowance', code: 'TRANSPORT', component_type: 'earning', is_percentage: false, fixed_amount: 400, is_active: true, is_taxable: false, is_recurring: true, affects_gosi: false, description_ar: 'بدل ثابت شهري', description_en: 'Fixed monthly allowance' },
  { name_ar: 'بدل الهاتف', name_en: 'Phone Allowance', code: 'PHONE', component_type: 'earning', is_percentage: false, fixed_amount: 200, is_active: true, is_taxable: false, is_recurring: true, affects_gosi: false, description_ar: 'بدل ثابت شهري', description_en: 'Fixed monthly allowance' },
