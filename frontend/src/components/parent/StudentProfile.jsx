    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <p className="text-sm text-slate-600">{isRTL ? 'العنوان' : 'Address'}</p>
            <p className="font-medium">{student.address || (isRTL ? 'غير محدد' : 'Not provided')}</p>
          </div>
          <div>
            <p className="text-sm text-slate-600">{isRTL ? 'المدينة' : 'City'}</p>
            <p className="font-medium">{student.city || (isRTL ? 'غير محدد' : 'Not provided')}</p>
          </div>
          <div>
            <p className="text-sm text-slate-600">{isRTL ? 'جهة الاتصال الطارئة' : 'Emergency Contact'}</p>
            <p className="font-medium">{student.emergency_contact || (isRTL ? 'غير محدد' : 'Not provided')}</p>
          </div>
          <div>
            <p className="text-sm text-slate-600">{isRTL ? 'رقم الهاتف الطارئ' : 'Emergency Phone'}</p>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-slate-600 mb-2">{isRTL ? 'ملاحظات طبية' : 'Medical Notes'}</p>
