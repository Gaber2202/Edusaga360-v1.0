...
export default function BankExports() {
  ...
  const { data: profiles = [] } = useQuery({ enabled: false /* bank_export_profiles table not built */, queryKey: ['bankProfiles'], queryFn: () => fetchData(tenantQuery('bank_export_profiles').select('*').order('created_at', { ascending: false })), initialData: [] });
  ...
  const { data: payrollInputs = [] } = useQuery({ enabled: false /* payroll_inputs table not built */, queryKey: ['payrollInputs'], queryFn: () => fetchData(tenantQuery('payroll_inputs').select('*').order('created_at', { ascending: false })), initialData: [] });
