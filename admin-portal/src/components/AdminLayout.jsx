...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-sand flex">
      <aside className={`bg-najdi-900 text-white flex flex-col transition-all duration-200 ${collapsed ? 'w-16' : 'w-60'}`}>
        <div className="flex items-center gap-2 px-4 py-5 border-b border-najdi-900">
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                  isActive
                    ...
                    : 'text-muted-foreground hover:bg-najdi-900 hover:text-white'
        ...
        <button
          ...
          className="px-3 py-3 text-muted-foreground hover:text-white border-t border-najdi-900 flex items-center justify-center"
        >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 hover:bg-sand-alt rounded-lg px-2 py-1">
                ...
                <span className="text-sm text-ink hidden sm:inline">{user?.email}</span>
              </button>
            </DropdownMenuTrigger>
